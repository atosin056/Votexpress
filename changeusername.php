                ...
                <div class="col-lg-6 col-md-12 sign-in-container">
                    ...
                    <div class="sign-in">
                        ...
                        <form method="post">
                            ...
                            <p class="header">Change your Username</p>
                            ...
                            if (isset($_POST["submit"])) {
                                ...
                                $update = "UPDATE `users` SET `username`='".$new."' WHERE `username`='".$_SESSION["username"]."' AND `password`='".$_SESSION["password"]."'";
                            ...
                            <div class="form-outline myCustomFormOutline mb-4">
                                ...
                                <input type="text" name="new" class="form-control" value="<?php echo $_SESSION["username"] ?>" required>
