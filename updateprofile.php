	...
	if (isset($_FILES["photo"]) && $_FILES["photo"]["error"] <= 0) {
		...
		if (in_array($filetype, $allowed)) {
			...
			if (file_exists("posts/" . $filename)) {
				...
				$move = move_uploaded_file($_FILES["photo"]["tmp_name"], "profile/". $filename);

				if ($move) {
					
					$update = "UPDATE `users` SET `picture`='".$filename."' WHERE `username`='".$_SESSION["username"]."' AND `password`='".$_SESSION["password"]."'";
                ...
                <div class="col-lg-6 col-md-12 sign-in-container">
                    ...
                    <div class="sign-in">
                        ...
                        <form method="post" enctype="multipart/form-data">
                            ...
                            <p class="header">Change your Profile Picture</p>
                            ...
                            <input type="submit" name="submit" class="myCustomButton" value="Change Profile Picture">
