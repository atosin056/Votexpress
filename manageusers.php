				...
				<div class="content" style="display: flex;justify-content: center;align-items: center;background: transparent;">
					...
					<div class="container" style="padding-top: 60px;background: transparent;height: 100% !important;padding-left: 28px;">
						...
						<div style="width: 100% !important;">
							...
							<h4 style="font-weight: 600;">Remove Some Users</h4>
						...
						<div class="Table" style="background: white;">
							...
							if (mysqli_num_rows($select_query) > 0) {
								...
								while ($row = mysqli_fetch_assoc($select_query)) {
									...
									$_SESSION["man-user"] = $username;

									$_SESSION["man-i"] = $id;

									$_SESSION["man-p"] = $password;
							...
							<div style="display: flex;">
								...
								<div class="body"><?php echo $_SESSION["man-user"]; ?></div>

								<div class="body"><?php echo $_SESSION["man-p"]; ?></div>

								<div class="body" style="">
									
									<a href="userdelete.php?id=<?php echo $_SESSION["man-i"]; ?>" style="color: inherit;text-decoration: none;">
