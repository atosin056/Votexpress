                ...
                <div class="col-lg-6 col-md-12 sign-in-container">
                    ...
                    <div class="sign-in">
                        ...
                        <form method="post">
                            ...
                            <p class="header"><?php echo $_SESSION["ad-username"] ?>,Change your password</p>
                            ...
                            if (isset($_POST["submit"])) {
                                ...
                                $update = "UPDATE `administrators` SET `password`='".md5($new)."' WHERE `username`='".$_SESSION["ad-username"]."' AND `password`='".$_SESSION["ad-password"]."'";
