                ...
                <div class="col-lg-6 col-md-12 sign-in-container">
                    ...
                    <div class="sign-in">
                        ...
                        <form method="post">
                            ...
                            <p class="header"><?php echo $_SESSION["ad-username"] ?> Change your Username</p>
                            ...
                            if (isset($_POST["submit"])) {
                                ...
                                $select = "SELECT * FROM `administrators` WHERE `username`='".$new."'"; 
                                ...
                                if (mysqli_num_rows($select_query) > 0) {
                                    ...
                                    echo '<div class="error-message">
                                            ...
                                            <p>We are sorry, You cannot use this username.</p>
                                ...
                                $update = "UPDATE `administrators` SET `username`='".$new."' WHERE `username`='".$_SESSION["ad-username"]."' AND `password`='".$_SESSION["ad-password"]."'";
                            ...
                            <div class="form-outline myCustomFormOutline mb-4">
                                ...
                                <input type="text" name="new" class="form-control" value="<?php echo $_SESSION["ad-username"] ?>" required>
                            ...
                            <input type="submit" name="submit" class="myCustomButton" value="Change Username">
